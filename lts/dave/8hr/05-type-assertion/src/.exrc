...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-commentary,~/.vim/plugged/fzf,~/.vim/plugged/vim-javascript,~/.vim/plugged/vim-titlecase,~/.vim/plugged/vim-floaterm,~/.vim/plugged/vim-lsp,~/.vim/plugged/vim-lsp-settings,~/.vim/plugged/ale,~/.vim/plugged/vim-vsnip-integ,/usr/share/vim/vimfiles,/usr/share/vim/vim91,/usr/share/vim/vimfiles/after,~/.vim/plugged/vim-javascript/after,~/.vim/plugged/vim-vsnip-integ/after,~/.vim/after
set shiftwidth=4
set showmatch
set smartcase
set smartindent
