...
element = (
  <button onClick={ tombolDitekan.bind(this, "You just clicked me right?") }>
  Click Me
  </button>
)
...
function App() {
    ...
    function addTodoHandler(event) {
        ...
        // console.log(activity) // console user type
        // setTodos([activity]) // this only replace if user input more then one
        setTodos([ // change the activity as an Object with "value" and "id" innIt
            ...todos,
            {
                id: generateId(),
                activity: activity,
    ...
    function removeTodoHandler(todoId) {
        console.log(todos, setTodos, todoId) /
    };
    ...
    return (
        ...
        { todos.map(function (todo) {
            return (
                ...
                </li>  // will look onto the id we want to remove
            )
        }) }  
        </ul>
