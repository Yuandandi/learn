...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-commentary,~/.vim/plugged/refactoring.nvim,~/.vim/plugged/cellular-automaton.nvim,~/.vim/plugged/sparkup,~/.vim/plugged/bracey.vim,~/.vim/plugged/fzf,~/.vim/plugged/undotree,~/.vim/plugged/vim-table-mode,~/.vim/plugged/vim-javascript,~/.vim/plugged/vim-jsx,~/.vim/plugged/vim-css3-syntax,/usr/share/vim/vimfiles,/usr/share/vim/vim91,/usr/share/vim/vimfiles/after,~/.vim/plugged/vim-javascript/after,~/.vim/plugged/vim-jsx/after,~/.vim/plugged/vim-css3-syntax/after,~/.vim/after
set shiftwidth=4
set showmatch
set smartcase
set smartindent
